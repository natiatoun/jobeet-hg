...
$t = new lime_test(9);
$t->is(Jobeet::slugify('Sensio'), 'sensio', '::slugify() converts all characters to lowercase');
$t->is(Jobeet::slugify('sensio labs'), 'sensio-labs', '::slugify() replaces white space by a -');
...
$t->is(Jobeet::slugify(''), 'n-a', '::slugify() replaces empty url by \'n-a\'');
$t->is(Jobeet::slugify(' ,,,, '), 'n-a', '::slugify() replaces a string that only contains non-ASCII characters to \'n-a\'');
